...
I will start cleaning by changing names and date formats.

I will also make a backup of each dataframes and make my changes on the new datasets
...
Now that I have cleaned the data I will plot the data
...
-   This plot suggests that user's who take more steps tend to spend less time sitting. This negative correlation is visually represented by the downward-sloping trend line.
...
-   If we can send a notice during long periods of Sedentary activities we could encourage users to walk more.

-   We could use our sleep data to get our users into a healthy sleep patterns and for users who have trouble falling asleep we could offer meditation music or a short video to help customers relax and de-stress before bed

-   Using the data we can see when and what day users are most likely to work out. Depending on jobs they may already walk a lot. Users who don't meet there weekly goals can get a notification to encourage more daily steps

-   If users are near each other they could share their goals with other members or have weekly gatherings to walk together.
